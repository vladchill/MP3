...
public class MP3Player {
    ...
    public void play (String fileName) {
        ...
        try {
            ...
            player.play();
            System.out.println("current value===="+currentVolumeValue);
    ...
    public void setVolume(int currentValue, int maximumValue) {
        try {
            ...
            if (currentValue == 0) {
                ...
                System.out.println("volume======="+calcVloume(currentValue, maximumValue));
                player.setGain(calcVloume(currentValue, maximumValue));
            }
        } catch (BasicPlayerException ex) {
            Logger.getLogger(MP3Player.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private double calcVloume(int currentValue, int maximumValue) {
